...
namespace AM.ApplicationCore
{
    public static class InMemorySource
    {
        ...
        public static readonly Staff CaptainStaff = new Staff { FullName= new FullName { FirstName = "captain", LastName = "Captain" }, EmailAddress = "captain@gmail.com", BirthDate = new DateTime(1965, 1, 1), EmployementDate = new DateTime(1999, 1, 1), Salary = 10000,  PassportNumber = "sp1" };
        public static readonly Staff Hostess1Staff = new Staff { FullName = new FullName { FirstName = "hostess1", LastName = "Hostess1" }, EmailAddress = "hostess1@gmail.com", BirthDate = new DateTime(1995, 1, 1), EmployementDate = new DateTime(2019, 1, 1), Salary = 5000, PassportNumber = "sp2" };
        public static readonly Staff Hostess2Staff = new Staff { FullName = new FullName { FirstName = "hostess2", LastName = "Hostess2" }, EmailAddress = "hostess2@gmail.com", BirthDate = new DateTime(1996, 1, 1), EmployementDate = new DateTime(2018, 1, 1), Salary = 6000, PassportNumber = "sp3" };
        public static readonly Traveller Traveller1 = new Traveller { FullName = new FullName { FirstName = "traveller1", LastName = "Traveller1" }, BirthDate = new DateTime(1980, 1, 1), HealthInformation = "No troubles", Nationality = "American",  PassportNumber = "tp4" };
        public static readonly Traveller Traveller2 = new Traveller { FullName = new FullName { FirstName = "traveller2", LastName = "Traveller2" }, BirthDate = new DateTime(1981, 1, 1), HealthInformation = "Some troubles", Nationality = "French",PassportNumber = "tp5" };
        public static readonly Traveller Traveller3 = new Traveller { FullName = new FullName { FirstName = "traveller3", LastName = "Traveller3" }, BirthDate = new DateTime(1982, 1, 1), HealthInformation = "No troubles", Nationality = "Tunisian",  PassportNumber = "tp6" };
        public static readonly Traveller Traveller4 = new Traveller { FullName = new FullName { FirstName = "traveller4", LastName = "Traveller4" }, BirthDate = new DateTime(1983, 1, 1), HealthInformation = "Some troubles", Nationality = "American",  PassportNumber = "tp7" };
        public static readonly Traveller Traveller5 = new Traveller { FullName = new FullName { FirstName = "traveller5", LastName = "Traveller5" }, BirthDate = new DateTime(1984, 1, 1), HealthInformation = "Some troubles", Nationality = "Spanish", PassportNumber = "tp8" };
